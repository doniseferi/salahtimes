...
describe('geoCoordinates', () => {
  test('rejects a latitude value less than -90', () => {
    iterativeTest({
      ...
      assert: (value) => expect(() => geoCoordinate(throwOnError(degrees(value)), throwOnError(degrees(10)))).toThrow(RangeError)
    })
  })
  ...
  test('rejects a longitude value less than -180', () => {
    iterativeTest({
      ...
      assert: (value) => expect(() => geoCoordinate(throwOnError(degrees(10)), throwOnError(degrees(value)))).toThrow(RangeError)
    })
  })
  ...
  test('accept any latitude within the range of -90 to 90', () => {
    iterativeTest({
      ...
      assert: (value) => expect(() => geoCoordinate(throwOnError(degrees(value)), throwOnError(degrees(10)))).not.toThrow()
    })
  })
  test('accept any longitude within the range of -180 to 180', () => {
    iterativeTest({
      ...
      assert: (value) => expect(() => geoCoordinate(throwOnError(degrees(10)), throwOnError(degrees(value)))).not.toThrow()
    })
  })
})
...
describe('Create latitude', () => {
  ...
  test('returns the coordinate value passed in that is between -90 and 90', () => {
    iterativeTest({
      numberOfExecutions: 500,
      generateInput: () => generateRandomWholeNumber(-90, 90),
      assert: (value) => expect(throwOnError(createLatitude(value)).value).toEqual(value)
    })
  })
  test('rejects a latitude value less than -90', () => {
    iterativeTest({
      ...
      assert: (value) => expect(() => throwOnError(createLatitude(value))).toThrow(RangeError)
    })
  })
  test('rejects a latitude value greater than 90', () => {
    iterativeTest({
...
describe('Create longitude', () => {
  ...
  test('returns the coordinate value passed in that is between -180 and 180', () => {
    iterativeTest({
      numberOfExecutions: 500,
      generateInput: () => generateRandomWholeNumber(-180, 180),
      assert: (value) => expect(throwOnError(createLongitude(value)).value).toEqual(value)
    })
  })
  test('rejects a latitude value less than -180 and 180', () => {
    iterativeTest({
      ...
      assert: (value) => expect(() => throwOnError(createLongitude(value))).toThrow(RangeError)
    })
  })
