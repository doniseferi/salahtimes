  ...
  test('returns the correct time for Asr in UTC', () => {
    expect(closeEnough(
      getAsrDateTimeUtc(
        ...
        standard),
      new Date(
        Date.UTC(2032, 7, 1, 12, 45, 21, 236)).getTime(), 1.1e-10))
      .toEqual(true)
    expect(closeEnough(
      getAsrDateTimeUtc(
        new Date(2009, 11, 26),
        ...
        standard),
      new Date(
        Date.UTC(2009, 11, 26, 13, 40, 3, 478)).getTime(), 1.1e-10))
      .toEqual(true)
    expect(closeEnough(
      getAsrDateTimeUtc(
        new Date(2024, 5, 1),
        ...
        standard),
      new Date(
        Date.UTC(2024, 5, 1, 23, 53, 11, 190)).getTime(), 1.1e-10))
      .toEqual(true)
    expect(closeEnough(
      getAsrDateTimeUtc(
        new Date(2039, 2, 31),
        ...
        standard),
      new Date(
        Date.UTC(2039, 2, 31, 9, 22, 56, 998)).getTime(), 1.1e-10))
      .toEqual(true)
    expect(closeEnough(
      getAsrDateTimeUtc(
        new Date(2046, 2, 21),
        ...
        standard),
      new Date(
        Date.UTC(2046, 2, 22, 2, 19, 29, 700)).getTime(), 1.1e-10))
      .toEqual(true)
    expect(closeEnough(
      getAsrDateTimeUtc(
        new Date(2040, 1, 29),
        ...
        standard),
      new Date(
        Date.UTC(2040, 1, 29, 2, 32, 33, 196)).getTime(), 1.1e-10))
      .toEqual(true)
    expect(closeEnough(
      getAsrDateTimeUtc(new Date(2027, 11, 25),
        ...
        standard),
      new Date(
        Date.UTC(2027, 11, 25, 20, 59, 32, 738)).getTime(), 1.1e-10))
      .toEqual(true)
    expect(closeEnough(
      getAsrDateTimeUtc(
        new Date(2020, 5, 6),
        ...
        standard),
      new Date(
        Date.UTC(2020, 5, 6, 7, 31, 44, 417)).getTime(), 1.1e-10))
      .toEqual(true)
  })
})
  ...
  test('returns the correct time for Asr in UTC', () => {
    expect(closeEnough(
      getAsrDateTimeUtc(
        ...
        hanafi),
      new Date(
        Date.UTC(2026, 4, 5, 20, 22, 1, 116)).getTime(), 1.1e-10))
      .toEqual(true)
    expect(closeEnough(
      getAsrDateTimeUtc(
        new Date(2020, 4, 9),
        ...
        hanafi),
      new Date(
        Date.UTC(2020, 4, 9, 18, 54, 31, 45)).getTime(), 1.1e-10))
      .toEqual(true)
    expect(closeEnough(
      getAsrDateTimeUtc(
        new Date(2025, 5, 30),
        ...
        hanafi),
      new Date(
        Date.UTC(2025, 5, 30, 7, 48, 36, 87)).getTime(), 1.1e-10))
      .toEqual(true)
    expect(closeEnough(
      getAsrDateTimeUtc(
        new Date(2037, 1, 21),
        ...
        hanafi),
      new Date(
        Date.UTC(2037, 1, 21, 9, 46, 17, 737)).getTime(), 1.1e-10))
      .toEqual(true)
    expect(closeEnough(
      getAsrDateTimeUtc(
        new Date(2010, 7, 1),
        ...
        hanafi),
      new Date(
        Date.UTC(2010, 7, 1, 14, 1, 6, 400)).getTime(), 1.1e-10))
      .toEqual(true)
    expect(closeEnough(
      getAsrDateTimeUtc(
        new Date(2020, 2, 14),
        ...
        hanafi),
      new Date(
        Date.UTC(2020, 2, 14, 16, 44, 49, 515)).getTime(), 1.1e-10))
      .toEqual(true)
    expect(closeEnough(
      getAsrDateTimeUtc(
        new Date(2023, 6, 31),
        ...
        hanafi),
      new Date(
        Date.UTC(2023, 6, 31, 11, 58, 45, 493)).getTime(), 1.1e-10))
      .toEqual(true)
    expect(closeEnough(
      getAsrDateTimeUtc(
        new Date(2027, 0, 27),
        ...
        hanafi),
      new Date(
        Date.UTC(2027, 0, 27, 14, 7, 38, 731)).getTime(), 1.1e-10))
      .toEqual(true)
  })
})
